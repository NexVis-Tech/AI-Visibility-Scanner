...
use AIVisibilityScanner\Scanner\Checks\Schema\Schema_Product_Validity;
use AIVisibilityScanner\Scanner\Checks\Schema\Schema_Localbusiness_Validity;
use AIVisibilityScanner\Scanner\Checks\Schema\Schema_Review_Validity;
...
class Check_Registry {
	...
	private function register_default_checks() {
		...
		$this->register_check( new Schema_Product_Validity() );
		$this->register_check( new Schema_Localbusiness_Validity() );
		$this->register_check( new Schema_Review_Validity() );
